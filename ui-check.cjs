...
(async()=>{
  ...
  try {
    ...
    assert.match(await page.locator('header').evaluate(el=>getComputedStyle(el).backgroundImage),/retrowave-animated.svg/);
    const frame1=await page.locator('header').screenshot();
    await page.waitForTimeout(1200);
    const frame2=await page.locator('header').screenshot();
