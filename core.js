...
globalThis.Ledger = (() => {
  ...
  const defaults = {theme:'dark-green', animateRetrowave:true, hideRecommendations:true, resetOnNavigate:true, showHeaderButton:true, showPausedOnly:false, backgroundGroupChecks:true, reviewPreference:''};
  const groupSorts={
  ...
  function settings(value = {}) {
    ...
    for (const key of ['animateRetrowave','hideRecommendations','resetOnNavigate','showHeaderButton','showPausedOnly','backgroundGroupChecks']) if (typeof value?.[key] === 'boolean') result[key] = value[key];
