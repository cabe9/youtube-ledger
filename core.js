...
globalThis.Ledger = (() => {
  ...
  const defaults = {theme:'dark-green', animateRetrowave:true, hideRecommendations:true, resetOnNavigate:true, showHeaderButton:true, showPausedOnly:false, reviewPreference:''};
  const groupSorts={
