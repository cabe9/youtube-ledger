...
1. Download [the Chrome ZIP](https://github.com/cabe9/youtube-ledger/releases/download/v0.6.8/youtube-ledger-chrome-0.6.8.zip) and extract it to a permanent folder.
...
1. Download and extract [the Firefox ZIP](https://github.com/cabe9/youtube-ledger/releases/download/v0.6.8/youtube-ledger-firefox-0.6.8.zip).
...
Retrowave includes an animated grid, twinkling stars, and sunset glow. Toggle **Animate retrowave** in Advanced settings and save to enable or disable motion. System reduced-motion preferences use the static artwork.
