...
async function render() {
  ...
  $('recommendation-summary').textContent = `${reveals} deliberate reveals · ${visible} detected on screen · ${short} videos played for ≤${preferences.shortMinutes} min today (includes videos in progress)`;
